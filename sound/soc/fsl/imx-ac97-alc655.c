/*
 * imx-ac97-alc655.c -- SoC audio for i.MX Seco UDOO board with
...
static struct snd_soc_ops imx_alc655_audio_ops = {
	.hw_params = imx_alc655_audio_params,
};


static struct snd_soc_dai_link imx_alc655_dai = {
	.name		    = "alc655-AC97",
	.stream_name	= "ALC655-analog",
	.codec_dai_name	= "alc655-hifi-analog",
};


static struct snd_soc_card imx_alc655_card = {
	.name		= "imx-alc655-audio",
	.owner  	= THIS_MODULE,
	.dai_link	= &imx_alc655_dai,
	.num_links	= 1,
};
...
static int imx_alc655_probe (struct platform_device *pdev) {
	...
	imx_alc655_dai.codec_name = dev_name (&codec_pdev->dev);
	imx_alc655_dai.cpu_of_node = ssi_np;
	imx_alc655_dai.cpu_dai_name = dev_name (&ssi_pdev->dev);
	imx_alc655_dai.platform_of_node = ssi_np;
